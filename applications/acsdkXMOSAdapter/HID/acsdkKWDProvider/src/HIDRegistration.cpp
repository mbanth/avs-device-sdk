...
std::unique_ptr<acsdkKWDImplementations::AbstractKeywordDetector> createHIDKWDAdapter(
...
/// The registration object to register the XMOS HID adapter's creation method.
static const KeywordDetectorProvider::KWDRegistration g_hidAdapterRegistration(createHIDKWDAdapter);
